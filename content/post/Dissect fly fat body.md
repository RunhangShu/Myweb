...
&emsp;&emsp; Soak in PBS buffer for 10 seconds and remove the extra buffer with a pipette. Too much buffer will make the microscope hard to focus and insufficient buffer will dry really quick. 

<img src="/post/pics/fatbody_fig3.jpg" alt="" width="400px" height="600px"/>

## Step4: Remove the crop, gut and reprodutive organs 

&emsp;&emsp;  Use a pair of fine forceps to tease apart the abdomen (If you make the abdomen tense in the Step1, this step is easier). 
